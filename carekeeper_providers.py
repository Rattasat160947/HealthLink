...
class RealCareKeeperProvider(CareKeeperProvider):
    ...
    _SPO2_ERROR_MESSAGES = {
        ...
        # Not a placement problem at all: the sensor stopped handing over
        # samples, which is wiring or a hung sensor, not the finger.
        "NO_DATA": "เซนเซอร์ SpO2 ไม่ส่งข้อมูล (ตรวจสายเชื่อมต่อ I2C แล้วลองใหม่อีกครั้ง)",
    }
    ...
    _SPO2_QUALITY_MESSAGES = {
        ...
        "NO_PULSE": "ไม่พบจังหวะชีพจรในสัญญาณ (ยังไม่ได้วางนิ้ว วางไม่แนบ กดแรงเกินไป หรือมือเย็น/เลือดไหลเวียนน้อย) กรุณาวางนิ้วให้แนบเบาๆ และอุ่นมือก่อนวัดใหม่",
